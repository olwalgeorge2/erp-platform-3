...
## 1. Purpose
1.1 Implement the application layer for the BI component within the Business Intelligence area of the Business Intelligence context.
...
3.2 Outbound: Domain ports implemented by `bi-infrastructure` for persistence and external integrations.
3.3 Observability: Emits metrics, traces, and structured logs following platform instrumentation standards.

## 4. Related Modules
4.1 `bi-domain/` - Core domain logic and business invariants.
4.2 `bi-infrastructure/` - Adapter implementations for persistence and integrations.
