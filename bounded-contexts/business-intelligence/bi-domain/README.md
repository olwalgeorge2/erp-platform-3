...
## 1. Purpose
1.1 Provide the domain layer for the BI component inside the Business Intelligence area of the Business Intelligence context.
...
3.1 Expose ports for repositories, gateways, and policies to be implemented by `bi-infrastructure`.
...
## 4. Related Modules
4.1 `bi-application/` - Coordinates use cases and DTO mapping for this component.
4.2 `bi-infrastructure/` - Satisfies the ports and adapters declared in the domain.
