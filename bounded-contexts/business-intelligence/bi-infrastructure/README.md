# BI Infrastructure Module

## 1. Purpose
1.1 Deliver the infrastructure layer for the BI component within the Business Intelligence area of the Business Intelligence context.
...
2.1 Implement repositories, gateways, and clients declared in `bi-domain`.
...
## 4. Related Modules
4.1 `bi-application/` - Leverages these adapters to service client workflows.
4.2 `bi-domain/` - Declares the ports and business contracts satisfied here.
