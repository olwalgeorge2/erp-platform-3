...
## 1. Purpose
1.1 Provide the domain layer for the B2B component inside the Commerce B2B area of the Commerce context.
...
3.1 Expose ports for repositories, gateways, and policies to be implemented by `b2b-infrastructure`.
...
## 4. Related Modules
4.1 `b2b-application/` - Coordinates use cases and DTO mapping for this component.
4.2 `b2b-infrastructure/` - Satisfies the ports and adapters declared in the domain.
