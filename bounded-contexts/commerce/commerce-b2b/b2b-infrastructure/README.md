# B2B Infrastructure Module

## 1. Purpose
1.1 Deliver the infrastructure layer for the B2B component within the Commerce B2B area of the Commerce context.
...
2.1 Implement repositories, gateways, and clients declared in `b2b-domain`.
...
## 4. Related Modules
4.1 `b2b-application/` - Leverages these adapters to service client workflows.
4.2 `b2b-domain/` - Declares the ports and business contracts satisfied here.
