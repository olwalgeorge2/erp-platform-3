...
## 1. Purpose
1.1 Provide the domain layer for the Ecommerce component inside the Commerce Ecommerce area of the Commerce context.
...
3.1 Expose ports for repositories, gateways, and policies to be implemented by `ecommerce-infrastructure`.
...
## 4. Related Modules
4.1 `ecommerce-application/` - Coordinates use cases and DTO mapping for this component.
4.2 `ecommerce-infrastructure/` - Satisfies the ports and adapters declared in the domain.
