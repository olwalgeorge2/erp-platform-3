...
## 1. Purpose
1.1 Deliver the infrastructure layer for the Marketplace component within the Commerce Marketplace area of the Commerce context.
...
2.1 Implement repositories, gateways, and clients declared in `marketplace-domain`.
...
## 4. Related Modules
4.1 `marketplace-application/` - Leverages these adapters to service client workflows.
4.2 `marketplace-domain/` - Declares the ports and business contracts satisfied here.
