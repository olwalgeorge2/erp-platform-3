...
## 1. Purpose
1.1 Provide the domain layer for the POS component inside the Commerce POS area of the Commerce context.
...
3.1 Expose ports for repositories, gateways, and policies to be implemented by `pos-infrastructure`.
...
## 4. Related Modules
4.1 `pos-application/` - Coordinates use cases and DTO mapping for this component.
4.2 `pos-infrastructure/` - Satisfies the ports and adapters declared in the domain.
