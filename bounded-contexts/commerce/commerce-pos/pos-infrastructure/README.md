# POS Infrastructure Module

## 1. Purpose
1.1 Deliver the infrastructure layer for the POS component within the Commerce POS area of the Commerce context.
...
2.1 Implement repositories, gateways, and clients declared in `pos-domain`.
...
## 4. Related Modules
4.1 `pos-application/` - Leverages these adapters to service client workflows.
4.2 `pos-domain/` - Declares the ports and business contracts satisfied here.
