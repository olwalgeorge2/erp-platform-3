...
## 1. Purpose
1.1 Provide the domain layer for the Assets component inside the Corporate Assets area of the Corporate Services context.
...
3.1 Expose ports for repositories, gateways, and policies to be implemented by `assets-infrastructure`.
...
## 4. Related Modules
4.1 `assets-application/` - Coordinates use cases and DTO mapping for this component.
4.2 `assets-infrastructure/` - Satisfies the ports and adapters declared in the domain.
