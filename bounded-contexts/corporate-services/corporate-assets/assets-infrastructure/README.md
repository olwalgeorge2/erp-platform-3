...
## 1. Purpose
1.1 Deliver the infrastructure layer for the Assets component within the Corporate Assets area of the Corporate Services context.
...
2.1 Implement repositories, gateways, and clients declared in `assets-domain`.
...
## 4. Related Modules
4.1 `assets-application/` - Leverages these adapters to service client workflows.
4.2 `assets-domain/` - Declares the ports and business contracts satisfied here.
