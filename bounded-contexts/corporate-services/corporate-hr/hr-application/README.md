# HR Application Module

## 1. Purpose
1.1 Implement the application layer for the HR component within the Corporate HR area of the Corporate Services context.
...
3.2 Outbound: Domain ports implemented by `hr-infrastructure` for persistence and external integrations.
3.3 Observability: Emits metrics, traces, and structured logs following platform instrumentation standards.

## 4. Related Modules
4.1 `hr-domain/` - Core domain logic and business invariants.
4.2 `hr-infrastructure/` - Adapter implementations for persistence and integrations.
