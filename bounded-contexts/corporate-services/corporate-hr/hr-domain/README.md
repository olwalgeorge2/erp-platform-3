...
## 1. Purpose
1.1 Provide the domain layer for the HR component inside the Corporate HR area of the Corporate Services context.
...
3.1 Expose ports for repositories, gateways, and policies to be implemented by `hr-infrastructure`.
...
## 4. Related Modules
4.1 `hr-application/` - Coordinates use cases and DTO mapping for this component.
4.2 `hr-infrastructure/` - Satisfies the ports and adapters declared in the domain.
