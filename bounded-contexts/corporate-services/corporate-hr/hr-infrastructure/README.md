# HR Infrastructure Module

## 1. Purpose
1.1 Deliver the infrastructure layer for the HR component within the Corporate HR area of the Corporate Services context.
...
2.1 Implement repositories, gateways, and clients declared in `hr-domain`.
...
## 4. Related Modules
4.1 `hr-application/` - Leverages these adapters to service client workflows.
4.2 `hr-domain/` - Declares the ports and business contracts satisfied here.
