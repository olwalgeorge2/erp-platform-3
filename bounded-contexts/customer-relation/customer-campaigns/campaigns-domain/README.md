# Campaigns Domain Module

## 1. Purpose
1.1 Provide the domain layer for the Campaigns component inside the Customer Campaigns area of the Customer Relation context.
...
3.1 Expose ports for repositories, gateways, and policies to be implemented by `campaigns-infrastructure`.
...
## 4. Related Modules
4.1 `campaigns-application/` - Coordinates use cases and DTO mapping for this component.
4.2 `campaigns-infrastructure/` - Satisfies the ports and adapters declared in the domain.
