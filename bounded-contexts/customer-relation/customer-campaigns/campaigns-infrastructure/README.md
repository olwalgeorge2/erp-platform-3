# Campaigns Infrastructure Module

## 1. Purpose
1.1 Deliver the infrastructure layer for the Campaigns component within the Customer Campaigns area of the Customer Relation context.
...
2.1 Implement repositories, gateways, and clients declared in `campaigns-domain`.
...
## 4. Related Modules
4.1 `campaigns-application/` - Leverages these adapters to service client workflows.
4.2 `campaigns-domain/` - Declares the ports and business contracts satisfied here.
