...
## 1. Purpose
1.1 Implement the application layer for the CRM component within the Customer CRM area of the Customer Relation context.
...
3.2 Outbound: Domain ports implemented by `crm-infrastructure` for persistence and external integrations.
3.3 Observability: Emits metrics, traces, and structured logs following platform instrumentation standards.

## 4. Related Modules
4.1 `crm-domain/` - Core domain logic and business invariants.
4.2 `crm-infrastructure/` - Adapter implementations for persistence and integrations.
