...
## 1. Purpose
1.1 Provide the domain layer for the CRM component inside the Customer CRM area of the Customer Relation context.
...
3.1 Expose ports for repositories, gateways, and policies to be implemented by `crm-infrastructure`.
...
## 4. Related Modules
4.1 `crm-application/` - Coordinates use cases and DTO mapping for this component.
4.2 `crm-infrastructure/` - Satisfies the ports and adapters declared in the domain.
