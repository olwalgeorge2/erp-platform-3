# CRM Infrastructure Module

## 1. Purpose
1.1 Deliver the infrastructure layer for the CRM component within the Customer CRM area of the Customer Relation context.
...
2.1 Implement repositories, gateways, and clients declared in `crm-domain`.
...
## 4. Related Modules
4.1 `crm-application/` - Leverages these adapters to service client workflows.
4.2 `crm-domain/` - Declares the ports and business contracts satisfied here.
