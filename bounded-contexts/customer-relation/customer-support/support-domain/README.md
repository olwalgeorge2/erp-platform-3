...
## 1. Purpose
1.1 Provide the domain layer for the Support component inside the Customer Support area of the Customer Relation context.
...
3.1 Expose ports for repositories, gateways, and policies to be implemented by `support-infrastructure`.
...
## 4. Related Modules
4.1 `support-application/` - Coordinates use cases and DTO mapping for this component.
4.2 `support-infrastructure/` - Satisfies the ports and adapters declared in the domain.
