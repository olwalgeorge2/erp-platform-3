...
## 1. Purpose
1.1 Provide the domain layer for the Accounting component inside the Financial Accounting area of the Financial Management context.
...
3.1 Expose ports for repositories, gateways, and policies to be implemented by `accounting-infrastructure`.
...
## 4. Related Modules
4.1 `accounting-application/` - Coordinates use cases and DTO mapping for this component.
4.2 `accounting-infrastructure/` - Satisfies the ports and adapters declared in the domain.
