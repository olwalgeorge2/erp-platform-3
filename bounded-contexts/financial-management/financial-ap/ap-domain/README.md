...
## 1. Purpose
1.1 Provide the domain layer for the AP component inside the Financial AP area of the Financial Management context.
...
3.1 Expose ports for repositories, gateways, and policies to be implemented by `ap-infrastructure`.
...
## 4. Related Modules
4.1 `ap-application/` - Coordinates use cases and DTO mapping for this component.
4.2 `ap-infrastructure/` - Satisfies the ports and adapters declared in the domain.
