# AP Infrastructure Module

## 1. Purpose
1.1 Deliver the infrastructure layer for the AP component within the Financial AP area of the Financial Management context.
...
2.1 Implement repositories, gateways, and clients declared in `ap-domain`.
...
## 4. Related Modules
4.1 `ap-application/` - Leverages these adapters to service client workflows.
4.2 `ap-domain/` - Declares the ports and business contracts satisfied here.
