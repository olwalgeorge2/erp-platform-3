...
class ApCommandValidationTestProfile : QuarkusTestProfile {
    override fun getConfigOverrides(): MutableMap<String, String> =
        mutableMapOf(
            ...
            "quarkus.datasource.jdbc.url" to "jdbc:h2:mem:ap-command-validation;MODE=PostgreSQL;DB_CLOSE_DELAY=-1",
