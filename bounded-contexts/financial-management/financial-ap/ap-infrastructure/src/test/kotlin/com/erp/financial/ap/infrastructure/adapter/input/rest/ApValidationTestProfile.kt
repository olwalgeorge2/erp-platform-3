...
class ApValidationTestProfile : QuarkusTestProfile {
    override fun getConfigOverrides(): MutableMap<String, String> =
        mutableMapOf(
            ...
            "quarkus.datasource.jdbc.url" to "jdbc:h2:mem:ap-validation;MODE=PostgreSQL;DB_CLOSE_DELAY=-1",
    ...
    companion object {
        private val EXCLUDED_TYPES =
            listOf(
                ...
                "com.erp.financial.ap.infrastructure.adapter.input.rest.VendorBillResource",
                "com.erp.financial.ap.infrastructure.adapter.input.rest.VendorResource",
            ).joinToString(",")
    }
}
