...
## 1. Purpose
1.1 Provide the domain layer for the AR component inside the Financial AR area of the Financial Management context.
...
3.1 Expose ports for repositories, gateways, and policies to be implemented by `ar-infrastructure`.
...
## 4. Related Modules
4.1 `ar-application/` - Coordinates use cases and DTO mapping for this component.
4.2 `ar-infrastructure/` - Satisfies the ports and adapters declared in the domain.
