...
class ArValidationTestProfile : QuarkusTestProfile {
    override fun getConfigOverrides(): MutableMap<String, String> =
        mutableMapOf(
            ...
            "quarkus.datasource.jdbc.url" to "jdbc:h2:mem:ar-validation;MODE=PostgreSQL;DB_CLOSE_DELAY=-1",
    ...
    companion object {
        private val EXCLUDED_TYPES =
            listOf(
                ...
                "com.erp.financial.ar.infrastructure.adapter.input.rest.CustomerInvoiceResource",
                "com.erp.financial.ar.infrastructure.adapter.input.rest.CustomerResource",
            ).joinToString(",")
    }
}
