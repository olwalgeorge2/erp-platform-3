...
## 1. Purpose
1.1 Provide the domain layer for the Stock component inside the Inventory Stock area of the Inventory Management context.
...
3.1 Expose ports for repositories, gateways, and policies to be implemented by `stock-infrastructure`.
...
## 4. Related Modules
4.1 `stock-application/` - Coordinates use cases and DTO mapping for this component.
4.2 `stock-infrastructure/` - Satisfies the ports and adapters declared in the domain.
