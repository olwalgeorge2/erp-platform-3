...
## 1. Purpose
1.1 Provide the domain layer for the Warehouse component inside the Inventory Warehouse area of the Inventory Management context.
...
3.1 Expose ports for repositories, gateways, and policies to be implemented by `warehouse-infrastructure`.
...
## 4. Related Modules
4.1 `warehouse-application/` - Coordinates use cases and DTO mapping for this component.
4.2 `warehouse-infrastructure/` - Satisfies the ports and adapters declared in the domain.
