...
## 1. Purpose
1.1 Provide the domain layer for the Maintenance component inside the Manufacturing Maintenance area of the Manufacturing Execution context.
...
3.1 Expose ports for repositories, gateways, and policies to be implemented by `maintenance-infrastructure`.
...
## 4. Related Modules
4.1 `maintenance-application/` - Coordinates use cases and DTO mapping for this component.
4.2 `maintenance-infrastructure/` - Satisfies the ports and adapters declared in the domain.
