...
## 1. Purpose
1.1 Implement the application layer for the Production component within the Manufacturing Production area of the Manufacturing Execution context.
...
3.2 Outbound: Domain ports implemented by `production-infrastructure` for persistence and external integrations.
3.3 Observability: Emits metrics, traces, and structured logs following platform instrumentation standards.

## 4. Related Modules
4.1 `production-domain/` - Core domain logic and business invariants.
4.2 `production-infrastructure/` - Adapter implementations for persistence and integrations.
