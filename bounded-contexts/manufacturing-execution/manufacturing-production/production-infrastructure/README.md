...
## 1. Purpose
1.1 Deliver the infrastructure layer for the Production component within the Manufacturing Production area of the Manufacturing Execution context.
...
2.1 Implement repositories, gateways, and clients declared in `production-domain`.
...
## 4. Related Modules
4.1 `production-application/` - Leverages these adapters to service client workflows.
4.2 `production-domain/` - Declares the ports and business contracts satisfied here.
