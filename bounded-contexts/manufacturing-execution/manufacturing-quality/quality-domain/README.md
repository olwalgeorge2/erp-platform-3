...
## 1. Purpose
1.1 Provide the domain layer for the Quality component inside the Manufacturing Quality area of the Manufacturing Execution context.
...
3.1 Expose ports for repositories, gateways, and policies to be implemented by `quality-infrastructure`.
...
## 4. Related Modules
4.1 `quality-application/` - Coordinates use cases and DTO mapping for this component.
4.2 `quality-infrastructure/` - Satisfies the ports and adapters declared in the domain.
