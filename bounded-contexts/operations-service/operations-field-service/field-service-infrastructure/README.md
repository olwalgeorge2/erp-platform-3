# Field Service Infrastructure Module

## 1. Purpose
1.1 Deliver the infrastructure layer for the Field Service component within the Operations Field Service area of the Operations Service context.
...
2.1 Implement repositories, gateways, and clients declared in `field-service-domain`.
...
## 4. Related Modules
4.1 `field-service-application/` - Leverages these adapters to service client workflows.
4.2 `field-service-domain/` - Declares the ports and business contracts satisfied here.
