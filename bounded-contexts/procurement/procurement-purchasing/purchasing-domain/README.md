...
## 1. Purpose
1.1 Provide the domain layer for the Purchasing component inside the Procurement Purchasing area of the Procurement context.
...
3.1 Expose ports for repositories, gateways, and policies to be implemented by `purchasing-infrastructure`.
...
## 4. Related Modules
4.1 `purchasing-application/` - Coordinates use cases and DTO mapping for this component.
4.2 `purchasing-infrastructure/` - Satisfies the ports and adapters declared in the domain.
