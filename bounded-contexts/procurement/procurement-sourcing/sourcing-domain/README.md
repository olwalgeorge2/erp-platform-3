# Sourcing Domain Module

## 1. Purpose
1.1 Provide the domain layer for the Sourcing component inside the Procurement Sourcing area of the Procurement context.
...
3.1 Expose ports for repositories, gateways, and policies to be implemented by `sourcing-infrastructure`.
...
## 4. Related Modules
4.1 `sourcing-application/` - Coordinates use cases and DTO mapping for this component.
4.2 `sourcing-infrastructure/` - Satisfies the ports and adapters declared in the domain.
