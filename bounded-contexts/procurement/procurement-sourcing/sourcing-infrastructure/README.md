# Sourcing Infrastructure Module

## 1. Purpose
1.1 Deliver the infrastructure layer for the Sourcing component within the Procurement Sourcing area of the Procurement context.
...
2.1 Implement repositories, gateways, and clients declared in `sourcing-domain`.
...
## 4. Related Modules
4.1 `sourcing-application/` - Leverages these adapters to service client workflows.
4.2 `sourcing-domain/` - Declares the ports and business contracts satisfied here.
