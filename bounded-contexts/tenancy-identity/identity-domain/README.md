...
## 1. Purpose
1.1 Provide the domain layer for the Identity component inside the Tenancy Identity area of the Tenancy Identity context.
...
3.1 Expose ports for repositories, gateways, and policies to be implemented by `identity-infrastructure`.
...
## 4. Related Modules
4.1 `identity-application/` - Coordinates use cases and DTO mapping for this component.
4.2 `identity-infrastructure/` - Satisfies the ports and adapters declared in the domain.
