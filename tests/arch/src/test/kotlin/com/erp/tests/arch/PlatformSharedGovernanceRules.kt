...
class PlatformSharedGovernanceRules {
    ...
    fun `platform-shared must not depend on bounded contexts`() {
        val rule: ArchRule =
            noClasses()
                .that()
                .resideInAPackage("com.erp.shared..")
                .should()
                .dependOnClassesThat()
                .resideInAnyPackage(
                    // Identity context
    ...
    fun `platform-shared must not depend on platform-infrastructure`() {
        val rule: ArchRule =
            noClasses()
                ...
                .should()
                .dependOnClassesThat()
                .resideInAPackage("com.erp.infrastructure..")
                .because(
                    "platform-shared should be the lowest-level module, " +
    ...
    fun `bounded contexts must not depend on each other directly`() {
        ...
        val identityRule: ArchRule =
            noClasses()
                .that()
                .resideInAPackage("com.erp.identity..")
                .should()
                .dependOnClassesThat()
                .resideInAnyPackage(
                    "com.erp.finance..",
        ...
        val financeRule: ArchRule =
            noClasses()
                .that()
                .resideInAnyPackage("com.erp.finance..", "com.erp.financial..")
                .should()
                .dependOnClassesThat()
                .resideInAnyPackage(
                    "com.erp.identity..",
        ...
        val commerceRule: ArchRule =
            noClasses()
                .that()
                .resideInAPackage("com.erp.commerce..")
                .should()
                .dependOnClassesThat()
                .resideInAnyPackage(
                    "com.erp.identity..",
    ...
    fun `platform-shared modules should only contain allowed types`() {
        ...
        noClasses()
            .that()
            .resideInAPackage("com.erp.shared.types..")
            .should()
        ...
        noClasses()
            ...
            .resideInAPackage("com.erp.shared.types..")
            .should()
            .haveSimpleNameContaining("Business")
    ...
    fun `common-types should only contain abstractions not implementations`() {
        noClasses()
            ...
            .because(
                "platform-shared/common-types should contain interfaces and abstractions, " +
        ...
        noClasses()
            ...
            .because(
                "platform-shared/common-types should not contain adapters " +
    ...
    fun `platform-shared should not contain JPA entities`() {
        val rule: ArchRule =
            noClasses()
                ...
                .because(
                    "platform-shared should not contain persistence entities - " +
    ...
    fun `platform-shared should not contain REST resources`() {
        val rule: ArchRule =
            noClasses()
                ...
                .because(
                    "platform-shared should not contain REST endpoints - " +
    ...
    fun `platform-shared should not contain Quarkus-specific services`() {
        val rule: ArchRule =
            noClasses()
                ...
                .orShould()
                .beAnnotatedWith("jakarta.enterprise.context.RequestScoped")
                .because(
                    "platform-shared should contain pure abstractions, " +
